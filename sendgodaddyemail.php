...
if ($uploadOk == 0) {
    echo "Sorry, your file was not uploaded.Please use the back button to go back and try again";
// if everything is ok, try to upload file
...
else
 {
	...
	//	echo 'beginning to send email';
		...
		$mailbody = '<p>This is an autogenerated mail sent when a user uploads his resume in your website.Please find his details and attached resume below</p> <p>Name:'.$name.'<br> Email:'.$email.'<br> Phone number:' .$phone.'</p>';
		...
		header("Location: http://efgh.tasaheelgroup.org/index.html"); /* Redirect browser */
		//exit();
	}
